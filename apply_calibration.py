...
def match_to_tracks(
    ...
    continuity_weight: float = 0.3  # Weight for trajectory continuity
) -> List[TrackedObject]:
    # Remove old tracks
                ...
                if abs(u_obj['x'] - l_obj['x']) <= window_size:
                    ...
                    for track in tracks:
                        if track.last_frame == idx - 1:  # Track from previous frame
                            ...
                            new_score = (upper_dist + lower_dist) * 0.3  # 0.3 is trajectory weight
...
if __name__ == "__main__":
    ...
    rectify_align_and_correct_images(
        ...
        output_dir="/Users/vdausmann/oyster_project/result_images/20250312_21.2_01",
